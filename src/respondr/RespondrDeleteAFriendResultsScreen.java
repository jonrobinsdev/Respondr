 ...
 * @author hmf5hnz
 */
public class RespondrDeleteAFriendResultsScreen extends javax.swing.JFrame {
    ...
    public RespondrDeleteAFriendResultsScreen(String[] results, String name) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Delete from Friends List");
                ...
                try (BufferedReader br = new BufferedReader(new FileReader("UserDatabase.txt"))) {
                    ...
                    while ((line = br.readLine()) != null) {
                        if (line.substring(0, 49).trim().equals(name)) {
                            ...
                            line = line.replace(resultsList.getModel().getElementAt(index).toString().substring(0, 49).trim() + "|", "");
                            try (PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("test.txt", true)))) {
                                out.println(line);
                                JOptionPane.showMessageDialog(null, "The selected person has been deleted from your Friends List.", "Person Added", JOptionPane.INFORMATION_MESSAGE);
                                //break;
                            } catch (IOException e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RespondrDeleteAFriendResultsScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RespondrDeleteAFriendResultsScreen(results, name).setVisible(true);
            }
        });
    }
