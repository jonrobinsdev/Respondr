 ...
 * @author HMF5HNZ
 */
public class RespondrAddAFriendScreen extends javax.swing.JFrame {

    /**
     * Creates new form RespondrAddAFriendScreen
     */
    private static String name;
    public RespondrAddAFriendScreen(String name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the name or email of the User you wish to add:");
        ...
        if (nameTextField.getText().equals("")) {
            try (BufferedReader br = new BufferedReader(new FileReader("UserDatabase.txt"))) {
                ...
                while ((line = br.readLine()) != null) {
                    if (line.substring(50, 99).trim().toLowerCase().contains(emailTextField.getText().trim().toLowerCase())) {
                        foundResults[i] = (line.substring(0, 99));
                        i++;
                        found = true;
                    }
                }
                ...
                if (found) {
                    RespondrAddAFriendResultsScreen resultScreen = new RespondrAddAFriendResultsScreen(foundResults, name);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RespondrAddAFriendScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RespondrAddAFriendScreen(name).setVisible(true);
            }
        });
    }
